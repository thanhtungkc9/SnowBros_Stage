...
public class RedEnemyScrollBehaviour : StateMachineBehaviour
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex) {
        ...
        if (animator.GetComponent<RedEnemyAI>().transform.localScale.x > 0)
        {
            ...
            if (animator.GetComponent<RedEnemyAI>().redEnemyBody.velocity.x < animator.GetComponent<RedEnemyAI>().scrollVelocity)
            {
